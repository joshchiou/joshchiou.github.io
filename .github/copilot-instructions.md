...
**Publications:** Cite in project pages with `{% cite bib_key %}`. Key bib keys: `chiou2021interpreting` (T1D + exocrine, _Nature_ 2021), `chiou2021single` (islet scATAC-seq), `sun2023plasma` (UKB-PPP, _Nature_ 2023), `intact2025multi` (Multi-INTACT).
